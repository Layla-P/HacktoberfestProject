...
namespace HacktoberfestProject.Web
{
	public class Startup
	{
      ...
      {
          ctx.Response.Headers.Add("Content-Security-Policy", "default-src 'self' 'unsafe-inline'; connect-src 'self' https://api.github.com;frame-src *.youtube.com; img-src 'self' *.githubusercontent.com;");
          await next();
      });
